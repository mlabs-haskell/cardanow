...
DATA_SOURCE="kupo"
# NOTE: this name is very verbose for now: this is the name that the uploaded file will have
EXPORTED_SNAPSHOT_BASE_PATH_WITH_DATA_SOURCE="${EXPORTED_SNAPSHOT_BASE_PATH}/${DATA_SOURCE}"
mkdir -p "${EXPORTED_SNAPSHOT_BASE_PATH_WITH_DATA_SOURCE}"
# shellcheck disable=SC2034
